function generateDivisionQuestions(numQuestions) {
    ...
    for (let i = 0; i < numQuestions; i++) {
        // Gera dois números aleatórios para a subtração
        const num1 = Math.floor(Math.random() * 2000) + 2;
        const num2 = Math.floor(Math.random() * 100) + 2; 
...
// Cria 10 perguntas de subtração
